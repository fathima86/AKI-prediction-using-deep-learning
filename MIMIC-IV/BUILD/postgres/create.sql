-------------------------------------------
-- Create the tables and mimiciv-IV schema --
-------------------------------------------
...
DROP SCHEMA IF EXISTS mimiciv_core CASCADE;
CREATE SCHEMA mimiciv_core;
...
DROP TABLE IF EXISTS mimiciv_core.admissions;
CREATE TABLE mimiciv_core.admissions
(
...
DROP TABLE IF EXISTS mimiciv_core.patients;
CREATE TABLE mimiciv_core.patients
(
  subject_id INTEGER NOT NULL,
...
DROP TABLE IF EXISTS mimiciv_core.transfers;
CREATE TABLE mimiciv_core.transfers
(
  subject_id INTEGER NOT NULL,
  hadm_id INTEGER,
